...
<head>
    ...
    <link rel="stylesheet" href="./css/tinchi.css" />
    ...
    <!-- js -->
    <script defer src="./js/tinchi.js"></script>
    <script defer type="module" src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.esm.js"></script>
    <script defer nomodule src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.js"></script>
...
<body>
    <div id="main">
                ...
                <div class="collapse navbar-collapse navbar__padd" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="#">Danh sách lớp tín chỉ</a>
                                </li>
                                <li>
        ...
        <!-- content tín chỉ-->
        <div class="content__tinchi">
            <h3 class="content__tinchi-title">Danh sách lớp môn học, mô đun</h3>
            <form class="form__tinchi">
                <div class="container">
                    <div class="row mt-4">
                        <!-- select 1 -->
                        ...
                        <div class="col-lg-2 ps-0 mb-2">
                            ...
                            <select class="form-select mt-1 namhoc" aria-label="Default select example"
                                id="nam__hoc">
                                <option class="option__namhoc">--Chọn năm học--</option>
                            </select>
                        </div>
                        <!-- select 3 -->
                        <div class="col-lg-1 ps-0 mb-2">
                            <label for="dot" class="content__name">Đợt:</label>
                            <select class="form-select mt-1 dot" aria-label="Default select example" id="dot">
                                <option value="1" selected>1</option>
                                <option value="2">2</option>
                            </select>
                        </div>
                        ...
                        <div class="col-lg-3 ps-0 mb-2">
                            ...
                            <select class="form-select mt-1 matui" aria-label="Default select " id="ma__tui">
                                <option selected>--Chọn môn học--</option>
                                <option value="1">TKH617 - Mạng máy tính</option>
                                <option value="2">CNT622 - An toàn bảo mật thông tin</option>
                            </select>
                        </div>

                        <!-- select 5 -->
                        <div class="col-lg-4 ps-0 mb-2">
                        ...
                        <!-- button tìm kiếm -->
                        <div class="text-end">
                            <button type="button" class="button_tinchi mt3 kyluat__padding">
                                Tìm kiếm
                            </button>
                            <button type="submit" class="button_excell mt3 kyluat__padding">
                                Xuất Excell
                            </button>
                        </div>
                    </div>
        ...
        <!-- table tín chỉ -->
        <div class="container mt-3 ps-0" id="table__tinchi" style="display: none">
                ...
                <table class="table table-bordered table-hover table-responsive" style="border: 1px solid #ccc">
                    <thead class="text-center" style="border-bottom: 2px solid #999">
                        <tr>
                            ...
                            <th class="bgc__th">Tên lớp quản lý</th>
                            <th class="bgc__th">Tên môn học</th>
                            <th class="bgc__th">Giảng viên</th>
                            <th class="bgc__th">Số TC</th>
                            <th class="bgc__th">Tổng số tiết</th>
                    ...
                    <tbody class="text-center">
                        <tr>
                            <td>1</td>
                            <td>TKH617_1621TKH01</td>
                            <td>1621TKH01</td>
                            <td>Mạng máy tính</td>
                            <td>gvcntttrangdtt-Đinh Thị Thu Trang</td>
                            <td>3</td>
                            <td>60</td>
                            <td>50</td>
                            <td><button class="btn__handle1">DSSV</button></td>
                            <td><button class="btn__handle2">Import</button></td>
                            <td><button class="btn__handle3">Export</button></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>TKH617_1621TKH01</td>
        ...
        <!-- button DDSV   -->
        <div>
            <h4 class="content__tinchi-title">
                Danh sách sinh viên lớp {CNT622_1621CNT01}
            </h4>
            <div class="container mt-3 ps-0" id="table__DDSV" style="display: block">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-responsive" style="border: 1px solid #ccc">
                        <thead class="text-center" style="border-bottom: 2px solid #999">
                            <tr>
                                <th class="bgc__th">STT</th>
                                <th class="bgc__th">Mã SV</th>
                                <th class="bgc__th">Họ tên</th>
                                <th class="bgc__th">Ngày sinh</th>
                                <th class="bgc__th">Tên lớp quản lý</th>
                                <th class="bgc__th">Tên môn</th>
                                <th class="bgc__th">Điện thoại</th>
                                <th class="bgc__th">
                    ...
                    <button class="btn__xoaSV">Xoá SV</button>
                </div>
            </div>
        </div>
