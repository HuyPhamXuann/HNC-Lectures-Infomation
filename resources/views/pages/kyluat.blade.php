...
<head>
    ...
    <title>Nhập hình thức kỷ luật</title>
    ...
    <link rel="stylesheet" href="./css/kyluat.css" />
    <link rel="stylesheet" href="./css/responsive.css" />
    <link rel="stylesheet" href="./css/index.css" />

    <!-- js -->
    <script defer src="./js/kyluat.js"></script>
...
<body>
    <div id="main">
        ...
        <!-- select ky luat -->
        <div class="content__kyluat">
            <h3 class="content__kyluat-title">Nhập hình thức kỷ luật</h3>
            <form class="form__kyluat">
                <div class="container">
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-2 ps-0 mb-2">
                            <label for="ma__tui" class="content__name">Mã túi:</label>
                            <select class="form-select mt-1 matui" id="ma__tui">
                                <option>--Chọn mã túi--</option>
                                <option value="1" selected>1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                            </select>
                ...
                <table class="table table-bordered table-hover table-responsive" style="border: 1px solid #ccc">
                    <thead class="text-center" style="border-bottom: 2px solid #999">
                        <tr>
                            ...
                            <th class="bgc__th">Duyệt kỷ luật</th>
                            <th class="bgc__th">Cán bộ nhập điểm</th>
                            <th class="bgc__th">#</th>
                            <th class="bgc__th">#</th>
                        </tr>
                    </thead>
